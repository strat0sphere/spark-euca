...
nohup $DAEMON_PATH/sbin/mesos-slave --executor_registration_timeout=5mins --log_dir=/mnt/mesos-logs --work_dir=/root/mesos-work-dir/ --master=10.2.221.173:5050 </dev/null >/dev/null 2>&1 &
sleep 3.0
