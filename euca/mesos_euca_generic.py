...
def setup_mesos_cluster(master, opts):
  ...
  ssh(master, opts, "chmod u+x spark-euca/setup-mesos-generic.sh")
  ssh(master, opts, "spark-euca/setup-mesos-generic.sh " + opts.installation_type + " " + opts.run_tests + " " + opts.restore + " " + str(opts.cohost))
