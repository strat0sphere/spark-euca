#!/bin/bash
apt-get -qq update
apt-get -qq --yes --force-yes install git

apt-get -qq --yes --force-yes install openjdk-7-jdk
...
apt-get -qq --yes --force-yes install openjdk-6-jdk
...
apt-get -qq --yes --force-yes install libgfortran3
